...
describe "#multiply" do
  ...
  it "multiplies two other numbers" do
    expect(multiply(1,1000)).to eq(1000)
  end

  it "multiplies two other numbers, one of them being 0" do
    expect(multiply(0,454)).to eq(0)
  end
...
describe "#power" do
  ...
  #--- J'AI AJOUTE DEUX TESTS -------
  it "raises another number to the power of another" do
    expect(power(10,2)).to eq(100) 
  end

  it "raises any number to the power of zero and return 1" do
